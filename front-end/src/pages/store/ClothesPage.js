...
class ClothesPage extends React.Component {
    ...
    //* Set state */
        ...
        super(props); 
            this.state = {
                ...
                storeProducts: JSON.parse(localStorage.getItem('clothesProducts')) || null,
            };
        }
    ...
    //* Fetch and save data in state after rendering components */
        componentDidMount() {
            ...
            //* Get clothesProducts from localstorage when mounting components */
                const storeProducts = JSON.parse(localStorage.getItem('clothesProducts'));
                    if(storeProducts) {
                        this.setState({ 
    ...
    //* Update/save data in localStorage when this.state changes */
        componentDidUpdate(_prevProps, prevState){   
            ...
            //* Update localstorage if storeProducts have changed */
            if(prevState.storeProducts !== this.state.storeProducts) {
                localStorage.setItem('clothesProducts', JSON.stringify(this.state.storeProducts));
            }
        }
