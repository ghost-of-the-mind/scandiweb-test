...
class AllPage extends React.Component {
    ...
    //* Set state */
        ...
        super(props);
            this.state = {
                productCategory: 'all',
                storeProducts: JSON.parse(localStorage.getItem('allProducts')) || null,
            };
        }
    ...
    //* Fetch and save data in state after rendering components */
        componentDidMount() {
            ...
            //* Get allProducts from localstorage when mounting components */
            const storeProducts = JSON.parse(localStorage.getItem('allProducts'));
                if(storeProducts) {
                    this.setState({ 
        ...
        componentDidUpdate(_prevProps, prevState){   
            //* Update localstorage if storeProducts have changed */
                if(prevState.storeProducts !== this.state.storeProducts) {
                    localStorage.setItem('allProducts', JSON.stringify(this.state.storeProducts));
                }
        }
